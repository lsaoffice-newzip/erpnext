...
def make_sales_invoice(source_name, target_doc=None, ignore_permissions=False):
	...
	def set_missing_values(source, target):
		...
		if source.custom_so_from_date:
			target.update({"from_dates":source.custom_so_from_date})
		if source.custom_so_to_date:
			target.update({"to_dates":source.custom_so_to_date})
